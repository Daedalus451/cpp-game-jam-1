...
// configuration step. It creates a namespace called `cpp-game-jam-1`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        cpp-game-jam-1::cmake::project_name,
        cpp-game-jam-1::cmake::project_version));// version string, acquired
